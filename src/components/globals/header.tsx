                ...
                <NavigationMenu>
                  <NavigationMenuList>
                    {navItems?.map((navMenuItem) => (
                      <NavigationMenuItem key={navMenuItem.id} className="text-muted-foreground">
                        {navMenuItem?.menu?.length === 0 ? (
                          ...
                          <NavigationMenuTrigger>
                            <span className="font-semibold">{navMenuItem.label}</span>
                          </NavigationMenuTrigger>
                        )}
                                        ...
                                        {typeof submenuItem?.link?.value === 'object' && (
                                          ...
                                          >
                                            {typeof submenuItem?.subenuIcon === 'object' && (
                                              <>
                                                <Image
                                                  src={imageUrl + submenuItem?.subenuIcon?.url}
                                                  width={24}
                                                  height={24}
                                                  alt={
                                                    submenuItem?.subenuIcon?.alt
                                                      ? submenuItem?.subenuIcon?.alt
                                                      : 'Icon Menu'
                                                  }
                                                  className="size-5"
